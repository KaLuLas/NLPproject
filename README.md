...
19. 训练集和测试集的大小范围问题
20. 可以看看判错的例子
21. 标签认真标一下361个关系对看看会不会好一点

|      | 特征                    | 映射区间大小 | 去除部分                                                     | 准确率%（50次平均 |
| ---- | ----------------------- | ------------ | ------------------------------------------------------------ | ----------------- |
| 1    | 人物关系出现文本词频    | ±4           | 什么都不去除                                                 | 35.3              |
| 2    | (下同）                 | (下同）      | **去除符号**（选定）                                             | **36.5**          |
| 3    |                         |              | 去除符号stopwords                                            | 23.2              |
| 4    |                         |              | 去除符号stopwords人名                                        | 23.2              |
| 5    | 人物关系出现文本词袋all |              | 去除符号                                                     | 浮动过大          |
| 6    | 文本词袋30 or 200       |              |                                                              | 13.0 浮动大       |
| 7    | 人物关系出现文本词频    | ±4           | **发现我一个标签标错了**（以下只去除符号版本） | **55.9**       |
| **8** |                         | ±3选定      | x修改投影的半径之后relation_record_dict 要重新创建 | **57.9**    |
| 9    |                         | ±2           |                                                              | 57.1              |
| 10   |                         | ±1           |                                                              | 57.0              |
| 11   |                         | ±0           |                                                              | 57.7             |
| 12 | 词袋 | ±3 | 确实是没戏了 | 52.7 |
| 13 | 回到人物关系出现文本词频 | ±3 | MAXENT 分类器没戏了 |  |
| 14 | 出现一次的词 |  |  | 57.7 |
| **15** | 出现一次的词 | ±0 |  | **59.0** |
| **16** | 同上 | 同上 | **训练集把前五分之一包含了** | 76.8 |
| 17 | related_word_freq | ±3 | **把人物关系记录字典改对了** | 70.37 |
| 18 |  | ±2 |  | 70.37 |
| 19 |  | ±1 |  | 70 |
| **20** |  | **±0** | **在这个基础上试着去掉stopword人名试试吧** | **76.38** |
| 21 | hapax_words | ±0 |  | 76.38 |
| 22 |  | ±1 | 和related_word_freq几乎一样了 | 70 |
