...
threshold: 出现次数小于等于此值的姓名信息键值对将被视为无效
...
5. 出场顺序的序列输出利用pandas **finished**，姓名字典的输出利用pandas，提及占比的一个饼状图
6. 打印信息做成一个整合的参数可选的函数，输入参数字典可能不同 **working on it**
7. 利用**出现投影字典**人物间关系亲密疏远的一个图
8. 添加选择文件读取功能
9. 关系提取开始
